...
export default function ProductDetail({ $target, initalState }) {
  ...
  $productDetail.addEventListener('change', e => {
    if (e.target.tagName === 'SELECT') {
      ...
      const selectedOption = selectedOptions.find(selecedOption => selecedOption.optionId === selectedOptionId);
